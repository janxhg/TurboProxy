...
package com.turbopowered.api.proxy.crypto;

import com.google.common.collect.ImmutableSet;
import com.turbopowered.api.network.ProtocolVersion;
import com.turbopowered.api.util.Ordered;
...
public interface IdentifiedKey extends KeySigned {
   ...
   * Returns null before the {@link com.turbopowered.api.event.connection.LoginEvent}.
   *
