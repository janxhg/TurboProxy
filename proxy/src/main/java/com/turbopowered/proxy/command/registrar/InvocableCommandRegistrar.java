...
package com.turbopowered.proxy.command.registrar;
...
import com.turbopowered.api.command.CommandInvocation;
import com.turbopowered.api.command.CommandMeta;
import com.turbopowered.api.command.CommandSource;
import com.turbopowered.api.command.InvocableCommand;
import com.turbopowered.proxy.command.VelocityCommandMeta;
import com.turbopowered.proxy.command.VelocityCommands;
import com.turbopowered.proxy.command.brigadier.VelocityArgumentBuilder;
import com.turbopowered.proxy.command.brigadier.VelocityBrigadierCommandWrapper;
import com.turbopowered.proxy.command.invocation.CommandInvocationFactory;
