...
import com.turbopowered.api.command.CommandManager;
import com.turbopowered.api.command.CommandMeta;
import com.turbopowered.api.command.CommandResult;
import com.turbopowered.api.command.CommandSource;
import com.turbopowered.api.event.command.CommandExecuteEvent;
import com.turbopowered.api.event.command.PostCommandInvocationEvent;
import com.turbopowered.api.plugin.PluginManager;
import com.turbopowered.proxy.command.brigadier.VelocityBrigadierCommandWrapper;
import com.turbopowered.proxy.command.registrar.BrigadierCommandRegistrar;
import com.turbopowered.proxy.command.registrar.CommandRegistrar;
import com.turbopowered.proxy.command.registrar.RawCommandRegistrar;
import com.turbopowered.proxy.command.registrar.SimpleCommandRegistrar;
  ...
  private boolean executeImmediately0(final CommandSource source, final ParseResults<CommandSource> parsed) {
    ...
    try {
      ...
      if (isSyntaxError) {
        ...
        result = com.turbopowered.api.command.CommandResult.SYNTAX_ERROR;
