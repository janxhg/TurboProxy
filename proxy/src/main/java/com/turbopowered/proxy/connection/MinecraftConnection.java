...
import static com.turbopowered.proxy.network.Connections.CIPHER_DECODER;
import static com.turbopowered.proxy.network.Connections.CIPHER_ENCODER;
import static com.turbopowered.proxy.network.Connections.COMPRESSION_DECODER;
import static com.turbopowered.proxy.network.Connections.COMPRESSION_ENCODER;
...
import com.turbopowered.natives.compression.VelocityCompressor;
import com.turbopowered.natives.encryption.VelocityCipher;
import com.turbopowered.natives.encryption.VelocityCipherFactory;
import com.turbopowered.natives.util.Natives;
import com.turbopowered.proxy.VelocityServer;
import com.turbopowered.proxy.connection.client.HandshakeSessionHandler;
import com.turbopowered.proxy.connection.client.InitialLoginSessionHandler;
import com.turbopowered.proxy.connection.client.StatusSessionHandler;
import com.turbopowered.proxy.network.Connections;
import com.turbopowered.proxy.protocol.MinecraftPacket;
import com.turbopowered.proxy.protocol.StateRegistry;
import com.turbopowered.proxy.protocol.VelocityConnectionEvent;
import com.turbopowered.proxy.protocol.netty.MinecraftCipherDecoder;
import com.turbopowered.proxy.protocol.netty.MinecraftCipherEncoder;
import com.turbopowered.proxy.protocol.netty.MinecraftCompressDecoder;
import com.turbopowered.proxy.protocol.netty.MinecraftCompressorAndLengthEncoder;
...
import com.turbopowered.proxy.protocol.netty.PlayPacketQueueInboundHandler;
import com.turbopowered.proxy.protocol.netty.PlayPacketQueueOutboundHandler;
import com.turbopowered.proxy.protocol.packet.SetCompressionPacket;
import com.turbopowered.proxy.util.except.QuietDecoderException;
...
import com.turbopowered.natives.compression.VelocityCompressorFactory;
...
public class MinecraftConnection extends ChannelInboundHandlerAdapter {
  ...
  public void setCompressionThreshold(int threshold) {
    setCompressionThreshold(threshold, null);
  }
   ...
   *
   * @param threshold the compression threshold to use
   * @param factory   the factory to use for creating the compressor, or null to use default
   */
  public void setCompressionThreshold(int threshold, @Nullable VelocityCompressorFactory factory) {
    ensureOpen();
    ensureInEventLoop();
    ...
    if (threshold == -1) {
      ...
      if (decoder != null && encoder != null) {
        ...
        if (factory != null) {
          compressor = factory.create(level);
        } else {
